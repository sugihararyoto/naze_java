...
public class PlayerClass {
	...
	/** 与えられた戦略 */
	private JankenTactics playerTactics;
	
	/*
	 * 関数名：setTactics
	 * 概要：プレイヤーに戦略を渡す
	 * 引数：JankenTactics setTactics
	 * 戻り値：なし
	 * 作成者：R.Sugihara
	 * 作成日：2023.06.26
	 */
	void setTactics(JankenTactics setTactics) {
		//プレイヤーに戦略を渡す
		playerTactics = setTactics;
	}
	...
	public int showHand() {
		...
		int playerHand = playerTactics.readTactics();
